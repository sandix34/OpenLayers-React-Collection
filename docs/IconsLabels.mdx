...
Pour afficher un icon, la classe [Icon](https://openlayers.org/en/latest/apidoc/module-ol_style_Icon-Icon.html) possède de nombreuses options liées notamment à la source, l'ancrage et au style de l'image.
